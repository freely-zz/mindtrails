...
public class rj_model_3: IPlayerA
{
    ...
    public List<Actions> MakeDecision(List<Vector3> blocks, int thisScore, float timeRemaining)
    {
        ...
        else if (turn > 0)
        {
            ...
            // UnityEngine.Debug.Log("@@@@@@@- blocks count");
            // UnityEngine.Debug.Log(blocks.Count);
        ...
        // UnityEngine.Debug.Log("@@@@@@@- area of true zone");
        // UnityEngine.Debug.Log(zones[trueAnchors].Value);
    ...
    public float Reward_fun(Dictionary<List<Vector3>, float> belief_P, Dictionary<List<Vector3>, float> suspition_P, float MIN_susp, List<Vector3> distribution)
    {
        ...
        return ((1.0f - (belief_P[trueAnchors] - Belief[trueAnchors])) + ((float)newRed / (float)pathLength) + (MIN_susp - suspition_P[trueAnchors]) );
    }
