...
public class GeneratorManager : MonoBehaviour
{
    ...
    {
        GameObject pickup = Methods.LayoutObject(GameManager.instance.pickupTiles[color], pos.x, pos.y);
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < GameParameters.instance.counterNumInGenerator; i++)
        {
            ...
            pickupPositions.Add(new Vector3(transform.position.x + d, transform.position.y, 0f));
            d += 1f * reverse;
        }
